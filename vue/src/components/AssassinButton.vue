<template>
  ...
  <button @click="filter" class="familyfriendly">Assassin</button>
</template>
...
<img src="${champ.id}" alt="aa" class="card__image">
    <h2>${champ.title}</h2>
    <button  onclick="aboutme()" id="sofax1" class="btn draw-border">Learn More</button>
...
.familyfriendly,.familyfriendly:link,.familyfriendly:visited{
